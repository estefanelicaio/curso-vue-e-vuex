    ...
    <div class="container">
        <div class="row">
            <div class="col-6 bg-light">
                ...
                <hr>
                <form @submit.prevent="enviar($event)" @reset.prevent="resetar()">
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-maska="'AAA#A#AA'" v-model="form.placaVeiculoMercosul">
            ...
            <div class="col-6 text-white bg-secondary" :style="'background-color:'+form.cor+'!important'">
                ...
                <div class="mb-3 row">
                    <span>Data/hora local: {{ form.dataHoraLocal }} || {{ $moment(form.dataHoraLocal).format('DD/MM/YYYY HH:mm') }}</span>
                </div>
                <div class="mb-3 row">
...
export default {
    ...
    data: () => ({
        cursos: [
            ...
            {id: 2, curso: 'Desenvolvimento com Vue'},
            {id: 3, curso: 'Desenvolvimento com Laravel'},
            {id: 4, curso: 'Docker e containers'},
        ],
        form: {},
        formEstadoInicial: {
            nome: 'Caio',
